...
| -------- | -------- |------------- |
| `automationName` | Qué motor de automatización usar | ```Java DesiredCapabilities dCapabilities = new DesiredCapabilities(); dCapabilities.setCapability(MobileCapabilityType.AUTOMATION_NAME, "uiautomator2"); ``` |
